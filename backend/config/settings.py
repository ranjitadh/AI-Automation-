...
# Database
DB_NAME = config('DB_NAME', default='ai_sdr_db')
DB_USER = config('DB_USER', default='ai_sdr_user')
DB_PASSWORD = config('DB_PASSWORD', default='ai_sdr_password')
...
AGENCY_PHONE = config('AGENCY_PHONE', default='+1-234-567-8900')
